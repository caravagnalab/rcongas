...
```{r}
set.seed(3)
res <- best_cluster(inp3,model = "MixtureGaussianOld", clusters = 1:4, steps = 800, lr = 0.01, param_list = list("theta_scale" = 3.2, "theta_rate" = 1, "cnv_var" = 0.50) , method = "BIC",  MAP = T, posteriors = F, step_post = 100)
