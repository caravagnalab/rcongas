...
```{r}
set.seed(3)
res <- best_cluster(inp3,model = "MixtureGaussian", clusters = 1:4, steps = 600, lr = 0.01, param_list = list("theta_scale" = 3.2, "theta_rate" = 1, "cnv_var" = 0.50) , method = "BIC", filt_merge = 0.8, MAP = T, posteriors = F)
