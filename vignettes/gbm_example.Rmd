...
subclones <- best_cluster(X = binned_express, clusters = 1:4, model = "MixtureGaussianNorm", steps = 400L, lr = 0.01, param_list = list(a = 0, b = 0.5, init_sd = 0.01), method = "BIC", mixture = mix_prior) 
