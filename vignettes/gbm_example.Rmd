...
df_norm_tum <-  calculate_DE(GMB_smartseq_normal_vs_tumor, input = glioblastoma_TPM, clone1 = 3, NULL, normalize = F)
  
df_5_no5 <- calculate_DE(GBM_smartseq_tumor_only, input = glioblastoma_TPM[,get_best_model(GBM_smartseq_tumor_only)$dim_names$cell_names], clone1 = 2, NULL, normalize = F)
  
df_14_no14 <- calculate_DE(GMB_smartseq_normal_vs_tumor, input = glioblastoma_TPM[,get_best_model(GBM_smartseq_tumor_only)$dim_names$cell_names], clone1 = 1,3, NULL, normalize = F)
