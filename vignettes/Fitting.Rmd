...
The init function has a paramter \code{multiome}, which is a flag that either enables or disables the multiome mode. This mode makes the inference
for the RNA and ATAC correspodning cells 
