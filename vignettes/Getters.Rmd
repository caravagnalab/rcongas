...
get_clusters_ploidy(rcongas_example)

# Zoom in one specific chromosome
get_clusters_ploidy(rcongas_example, chromosomes = 'chr2')

# Zoom in one specific cluster, here "1"
get_clusters_ploidy(rcongas_example, clusters = '1')

# Zoom in one specific chromosome and cluster
get_clusters_ploidy(rcongas_example, chromosomes = 'chr2', clusters = "1")
```
