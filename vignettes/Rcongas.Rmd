...
x = init(
  ...
  rna_normalisation_factors = example_input$x_rna %>% auto_normalisation_factor(),
  atac_normalisation_factors = NULL,
  rna_likelihood = "G", 
  atac_likelihood = NULL,
...
x = init(
  ...
  segmentation = example_input$x_segmentation,
  rna_normalisation_factors = example_input$x_rna %>% auto_normalisation_factor(),
  atac_normalisation_factors = example_input$x_atac %>% auto_normalisation_factor(),
  rna_likelihood = "G", 
  atac_likelihood = 'NB',
  description = 'My crazy model')
```
